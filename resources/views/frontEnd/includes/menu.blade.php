                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        @auth('web')
                    				...
                    				@elseif (Request::url() ==='http://127.0.0.1:8000/current-contest' || Request::url() === 'http://127.0.0.1:8000/current-contest/status' ||Request::url() === 'http://127.0.0.1:8000/current-contest/standings'|| Request::url() === 'http://127.0.0.1:8000/current-contest/my-submission'|| Request::url() === 'http://127.0.0.1:8000/current-contest/problems' )
                       ...
                       <!--  @if (Auth::guard('admin'))-->
                        @auth('admin')
                        		<li @yield('Active_home')><a href="{{url('/admin-home')}}">Home</a></li>
                       			<li @yield('Active_CC')><a href="{{url('/admin-home/create-contest')}}" >Create Contest<!--span class="glyphicon glyphicon-flag" aria-hidden="true"> </span --></a></li>
